...
<span class="pull-left"> Tafsilotlarni ko'rish </span>
...
<div>Mahsulot kategoriyalari</div>
...
<div class="row">
    <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
        ...
        <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
            ...
            <div>Kutilayotgan Buyurtmalar</div>
            ...
            <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
                ...
                <div>Bajarilgan Buyurtmalar</div>
...
<i class="fa fa-money fa-fw" ></i> Yangi Buyurtmalar
...
Barcha Buyurtmalarni Ko'rish <i class="fa fa-arrow-circle-right" ></i>
