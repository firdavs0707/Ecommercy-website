  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        My shop da <span class="nero__bold">Roʻyxatdan oʻtish</span>
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<h2> Yangi account ro'yxatdan o'tkazish </h2>
...
<label> Mijozning Elektron pochtasi</label>
...
<label> Mijozning mamlakati </label>
...
<label> Mizoojning telefon raqami </label>
...
<label> Mijozning aniq manzili </label>
...
if(val.length<=6)no=1;
 ...
 // If the password length is greater than 6 and contain any lowercase alphabet or any number or any special character
  ...
  if(no==1)
  {
   ...
   document.getElementById("pass_type").innerHTML="Juda Sodda";
  }
  ...
  if(no==2)
  {
   ...
   document.getElementById("pass_type").innerHTML="Sodda";
  }
  ...
  if(no==3)
  {
   ...
   document.getElementById("pass_type").innerHTML="Yaxshi";
  }
  ...
  if(no==4)
  {
   ...
   document.getElementById("pass_type").innerHTML="Juda yaxshi";
  }
 }
